<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->codpro=H::GetPost("codpro");
			
			$this->fapedido = new Fapedido();
		        $this->arrp = $this->fapedido->sqlp($this->coddes,$this->codhas,$this->codpro);
	...
	function llenartitulosmaestro()
		{
              //  $this->titulosm=array();
				$this->titulosm[0]="Fecha Pedido";
				$this->titulosm[1]="Código Cliente";
				$this->titulosm[2]="Nombre Cliente";			
		     ...
		     if($dato["id"]!=$codruta)
		      {
		        $this->SetWidths(array($this->anchos[0],$this->anchos[1],$this->anchos[2]));
	    	        $this->SetAligns(array("L","C","C"));
	    	        $this->setBorder(1);
	    	        $this->Row(array($dato["fecped"],$dato["codpro"],$dato["nompro"]));
