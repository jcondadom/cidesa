    ...
    b.fn.extend({
        counter: function (a) {
            ...
            return this.each(function () {
                function e(c) {
                    if (typeof a.type === "string") switch (a.type) {
                    case "char":
                        if (a.count === "down") {
                            g = " character(s) left";
                            return a.goal - c
                        } else if (a.count === "up") {
                            g = "  Caracteres (" + a.goal + " máximo)";
                            return c
                        }
                        break;
                    case "word":
                ...
                f.bind("keyup click blur focus change paste", function (c) {
                    ...
                    case "up":
                        ...
                        if (e(c) === a.goal && a.type === "word") {
                            d = true;
                            break
                        } else if (e(c) > a.goal && a.type === "word") {
                            b(this).val("");
                            i.text("0");
                            d = true;
                            break
                    ...
                    case "down":
                        ...
                        if (e(c) === 0 && a.type === "word") d = true;
                        else if (e(c) < 0 && a.type === "word") {
                            b(this).val("");
                            d = true;
                            break
                        }
                    ...
                    f.keydown(function (h) {
                        if (d) {
                            this.focus();
                            if (h.keyCode !== 46 && h.keyCode !== 8) if (b(this).val().length > a.goal && a.type === "char") {
                                b(this).val(b(this).val().substring(0, a.goal));
                                return false
                            } else return h.keyCode !== 32 && h.keyCode !== 8 && a.type === "word" ? true : false;
                            else {
                                d = false;
                                return true
                            }
