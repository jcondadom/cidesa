...
(function () {
    ...
    function Hd(a, b) {
        function c(m, h) {
            ...
            var s = this,
                ...
                H = ma ? "x" : "y",
                A, D, ha, xa = M ? V : rb,
                va, Ka, tb, Hb, Fa, Ta, u, Z, pa, Na, P = null,
                K = null,
        ...
        var da = y(v.marginTop, I[0]),
            ...
            ud = v.spacingBottom,
            Vc = v.spacingLeft,
            uc, kc, tc, ba, Ab, rb, V, Pb, jb, Qb, ta, Od, Tc, vc, Xa, Pa, jd, Oc, Wc, vd, wd, Xc, q = this,
            ae = (I = v.events) && !! I.click,
            xd, hc, rc, nd, $b, Sd, yd, sa, wa, gc, Qc, Pc, od, Rb, Sb, qc, ic = v.showAxes,
            Rc = 0,
            ab = [],
            Gb, Ba = [],
            Ga, aa, kd, Nd, ld, pd, sc, sd, td, rd, md, Td, be = function (m) {
                function h(u, Z) {
                    var pa = u.legendItem,
                        Na = u.legendLine,
                        P = u.legendSymbol,
    ...
    var Aa = document,
        ...
        db = "",
        yb = "hover",
        Cc, bd, cd, dd, oc, Dc, Ec, Cd, Dd, ed, Ed, Fd, eb = ib.HighchartsAdapter,
        Db = eb || {},
        t = Db.each,
        zd = Db.grep,
        jc = Db.map,
    ...
    Ma = xb(mb, {
        ...
        translate: function () {
            var a = 0,
                ...
                W = 2 * Tb,
                ca, ka = pb(i, k),
                v, I, da, X = c.dataLabels.distance;
