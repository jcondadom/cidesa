...
(function () {
    var k = Highcharts,
        ...
        B = k.setOptions({
            lang: {
                ...
                downloadPDF: "Descargar en Archivo  .PDF",
    ...
    p(y.prototype, {
        ...
        contextMenu: function (b, c, a, f, d, i) {
            ...
            if (a + e.exportMenuWidth > l) b.right = l - a - d - o + "px";
            else b.left = a - o + "px";
            if (f + i + e.exportMenuHeight > g) b.bottom = g - f - o + "px";
            else b.top = f + i - o + "px";
            u(m, b)
        },
        addButton: function (b) {
            ...
            if (d.enabled !== false) {
                l = f.rect(0, 0, h, j, d.borderRadius, b).align(d, true).attr(p({
