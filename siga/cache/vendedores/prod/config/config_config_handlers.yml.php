...
$this->handlers['modules/acidetest/config/security.yml'] = new sfSecurityConfigHandler();
$this->handlers['modules/acidetest/config/security.yml']->initialize();
