...
function prueba(){
document.getElementById("sf_admin_content").style.marginRight="500px";
document.getElementById("sf_admin_bar").style.marginRight="210px";
}
...
$(document).ready(function(){
	//PARA PINTAR LAS FILAS PARES DE UN COLOR
	$('tr:not(:first):odd').css({'background-color':'#f5fcfe'});
	//PARA PINTAR LAS FILAS IMPARES DE OTRO COLOR
	$('tr:not(:first):even').css({'background-color':'#F2F2F2'});               
});
</script>
</html>
