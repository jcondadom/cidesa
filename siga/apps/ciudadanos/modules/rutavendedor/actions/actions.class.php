...
/**
 * rutavendedor actions.
 *
 * @package    siga
 * @subpackage rutavendedor
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class rutavendedorActions extends autorutavendedorActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $this->rutavendedor = $this->getRutavendedorOrCreate($codigo);
        $this->rutavendedor->setMunicipios(Ciudadanos::getMunicipios($codigo));

        break;
      case '2':
        $output = '[["","",""],["","",""],["","",""]]';

        $this->rutavendedor = $this->getRutavendedorOrCreate();
        $this->rutavendedor->setParroquias(Ciudadanos::getParroquias($codigo));
