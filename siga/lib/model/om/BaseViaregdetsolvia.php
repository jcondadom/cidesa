...
abstract class BaseViaregdetsolvia extends BaseObject  implements Persistent {
  ...
  public function get($m, $a)
	...
	public function getViaregsolvia($con = null)
	{
      ...
      $c = new Criteria();
      $c->add(ViaregsolviaPeer::ID,$this->viaregsolvia_id);
      
			$this->aViaregsolvia = ViaregsolviaPeer::doSelectOne($c, $con);
	...
	public function getViaregente($con = null)
	{
      ...
      $c = new Criteria();
      $c->add(ViaregentePeer::ID,$this->viaregente_id);
      
			$this->aViaregente = ViaregentePeer::doSelectOne($c, $con);
	...
	public function getViaregact($con = null)
	{
      ...
      $c = new Criteria();
      $c->add(ViaregactPeer::ID,$this->viaregact_id);
      
			$this->aViaregact = ViaregactPeer::doSelectOne($c, $con);
