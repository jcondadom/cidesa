...
abstract class BaseViaregdetgassolvia extends BaseObject  implements Persistent {
  ...
  public function get($m, $a)
	...
	public function getViaregdetsolvia($con = null)
	{
      ...
      $c = new Criteria();
      $c->add(ViaregdetsolviaPeer::ID,$this->viaregdetsolvia_id);
      
			$this->aViaregdetsolvia = ViaregdetsolviaPeer::doSelectOne($c, $con);
	...
	public function getViaregtipser($con = null)
	{
      ...
      $c = new Criteria();
      $c->add(ViaregtipserPeer::ID,$this->viaregtipser_id);
      
			$this->aViaregtipser = ViaregtipserPeer::doSelectOne($c, $con);
